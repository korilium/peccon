...
# !!! Main.UserApp is configured as an alias for Main.Peccon2 and you might encounter it in some tests
using Main.Peccon2, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Peccon2 tests" begin
  @includetests ARGS
end
